 ...
 * Generated for Laravel 5.1.46 (LTS) on 2018-06-29 16:36:59.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Hash {
        ...
        {
            return \Bueno\Utilities\Md5Hasher::make($value, $options);
        }
        ...
        {
            return \Bueno\Utilities\Md5Hasher::check($value, $hashedValue, $options);
        }
        ...
        {
            return \Bueno\Utilities\Md5Hasher::needsRehash($hashedValue, $options);
        }
...
namespace Bueno\Notifications { 
    ...
    class Flash {
        ...
        public static function clear()
        {
            return \Bueno\Notifications\FlashNotifier::clear();
        }
        ...
        {
            return \Bueno\Notifications\FlashNotifier::info($message);
        }
        ...
        {
            return \Bueno\Notifications\FlashNotifier::success($message);
        }
        ...
        {
            return \Bueno\Notifications\FlashNotifier::danger($message);
        }
        ...
        {
            return \Bueno\Notifications\FlashNotifier::message($message, $type);
        }
...
namespace CachetHQ\Segment\Facades { 
    ...
    class Segment {
        ...
        {
            return \Segment::init($secret, $options);
        }
         ...
         * @static 
         */ 
        public static function track($message)
        {
         ...
         * @static 
         */ 
        public static function identify($message)
        {
         ...
         * @static 
         */ 
        public static function page($message)
        {
         ...
         * @static 
         */ 
        public static function alias($message)
        {
            return \Segment::alias($message);
        }
        ...
        {
            return \Segment::validate($msg, $type);
        }
...
namespace  { 
    ...
    class Flash extends \Bueno\Notifications\Flash {}
    ...
    class Segment extends \CachetHQ\Segment\Facades\Segment {}
