...
return [
  ...
  'image_size' => [
    ...
    'ola_money' => [
      ...
      'salt'  => 'n7QRr98Ui4',
      'action_url'  => 'https://om.olacabs.com/olamoney/webview/index.html'
    ],

    'ola_money_testing' => [
        'accessToken' => '3u41p82uT1',
        'salt'  => 'n7QRr98Ui4',
        'action_url'  => 'http://sandbox.olamoney.in/olamoney/webview/index.html'
    ],
  ...
  'site'  => [
      'logo_text' => 'Good Food<br>Delivered to your doorstep<br>Open from 8am till 11:30 pm.',
      'catering_phone' => '+91-9811910258, +91-9899119353',
      'careers_email' => 'careers@bueno.cafe',
      'catering_email' => 'catering@bueno.cafe',
      ...
      'sales_email' => 'sales@bueno.cafe',
      'partner_email' => 'partners@bueno.cafe',
      'partner_text_1' => 'We are looking for people with an enthusiasm similar to ours to join in our effort to provide good food across Delhi NCR and India',
      'partner_text_2' => 'Contact Us if you are interested in becoming a Franchise Partner (cafe & kiosk)',
      'support_email'   => 'bueno@bueno.cafe',
      'phone' => '01139586767',
      'footer_phone'  => '01139586767',
      'corporate_phone' => '+91-9811910258, +91-9899119353',
      'enquiry_phone' => '01139586767',
      'enquiry_email' => 'info@bueno.cafe',
      'diksha_phone' => '+91-9999038851',
      'diksha_email' => 'dikshaschoolindia@gmail.com',
      'diksha_website' => 'www.dikshaschoolindia.org',
      'investment_phone'  => '91-98195-11928',
      'email' => 'bueno@bueno.cafe',
      'bcc_email' => 'care@bueno.cafe',
      'referral_email_text' => 'I really enjoyed my meal at Bueno made by 5 Star Chefs in their own kitchen and thought you would love it too! Try their online delivery service anytime between 11 am to 4 am in Gurgaon at www.bueno.cafe',
      'live_date' => '2015-09-01 00:00:00',
      'max_credit_usage_percent' => 25
  ],

  'email' => [
    'text_1' => 'A carefully curated 7 Cuisine Menu <br> for every mood and occasion<br><br>',
    'text_2'  => 'Delivery from 8.00 am till 11.30 pm <br> to satiate hunger at any time <br> of the day or night<br><br>',
  ...
  'pickup_default_address' => env('PICKUP_DEFAULT_ADDRESS','')
