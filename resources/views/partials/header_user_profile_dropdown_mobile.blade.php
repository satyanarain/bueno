<div class="user_dropdown dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="mobileNavDropdown">
        ...
        <li><a href="{{ route('users.loyalty.get')}}">Bueno Rewards</a></li>
...
<div class="profile_dropdown">
    <a class="nav_link nav_link_login" href="{{ route('users.cart.get')}}">
        Cart
    </a>
    <a class="nav_link nav_link_login" href="{{ route('users.logout') }}">
        Sign Out
    </a>
