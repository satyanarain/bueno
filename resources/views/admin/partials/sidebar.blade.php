        ...
        <ul>
          ...
          <li >
            <a href="{{URL::route('admin.business')}}" >
              <i class="ion-navigate"></i> <span>Business / Franchising Queries</span>
            </a>
          </li>
          @endif
          ...
          <li>
            <a href="{{URL::route('admin.catering')}}" >
              <i class="ion-coffee"></i> <span>Sales Leads</span>
            </a>
          </li>
          @endif
          ...
          <li>
            <a href="{{URL::route('admin.queries')}}" >
              <i class="ion-help"></i> <span>General Queries / Feedback</span>
            </a>
          </li>
          @endif
          ...
          <li>
            <a href="{{URL::route('admin.bulk_marketing_sms')}}" data-toggle="sidebar">
              <i class="ion-email"></i> <span>Marketing SMS</span>
              <i class="fa fa-chevron-down"></i>
            </a>
            <ul class="submenu">
              <li><a href="{{URL::route('admin.marketing_sms_template')}}">Send SMS</a></li>
              <li><a href="{{URL::route('admin.new_marketing_sms_template')}}">Add new SMS Template</a></li>
            </ul>
          </li>
