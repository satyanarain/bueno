      ...
      <div class="content-wrapper">
        ...
        {{csrf_field()}}
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10 col-md-8">
                <input type="text" class="form-control" name="unit_number" value="{{old('unit_number')}}" required=""/>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10 col-md-8">
                <input type="text" class="form-control" name="sub_area" value="{{old('sub_area')}}" required=""/>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 col-md-8">
                    <div class="has-feedback">
                        <select name="areas[]" multiple="multiple" class="GroupGroup form-control user-address-search">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10 col-md-8">
                    <input type="text" class="form-control" name="pickup_time"  required="" value="{{old('pickup_time')}}" />
                </div>
            </div>
              <!--<div class="form-group">
