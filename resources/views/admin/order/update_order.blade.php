  ...
  <div id="content">
            ...
            <div id="dashboard">
                      <div class="metrics clearfix">
                        ...
                        <div class="metric">
                          <span class="field">VAT</span>
                          <span class="data" id="total-amount">INR {{$order->invoice->where('charge_for','VAT')->first()->amount}}
                          </span>
                        </div>
                        <div class="metric">
                          <span class="field">Service Tax</span>
                          <span class="data" id="total-amount">INR {{$order->invoice->where('charge_for','Service Tax')->first()->amount}}
                          </span>
                        </div>
                        <div class="metric">
                          <span class="field">Service Charge</span>
                          <span class="data" id="total-amount">INR {{$order->invoice->where('charge_for','Service Charge')->first()->amount}}
                          </span>
                        </div>
                        <div class="metric">
                          <span class="field">Delivery Charge</span>
                          <span class="data" id="total-amount">INR {{$order->invoice->where('charge_for','Delivery Charge')->first()->amount}}
                          </span>
                        </div>
                        <div class="metric">
                          <span class="field">Packaging Charge</span>
                          <span class="data" id="total-amount">INR {{$order->invoice->where('charge_for','Packaging Charge')->first()->amount}}
                          </span>
                        </div>
                          <div class="metric">
            ...
            <div class="content-wrapper">
                ...
                <form id="update-order" class="form-horizontal" method="post" action="#" role="form">
                    ...
                    <div class="address">
                        <div class="form-group label-text">
                            <label class="col-sm-2 col-md-2 control-label">Delivery/Pickup</label>
                            <div class="col-sm-10 col-md-8">
