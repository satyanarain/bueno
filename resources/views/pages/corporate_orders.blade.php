            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="well padding-md">
                        <h3 class="normal_header">Corporate / Bulk Orders</h3>
                    </div> <!-- well ends -->

                    <div class="static_content col-xs-12">
                        <div class="main col-xs-12 col-sm-6 col-md-4">
                            <h4>We undertake small as well as large scale orders for all corporate/home/other events.</h4>
                            <div class="border-block black full_width text-center margintop-lg">
                                <label>Call / WhatsApp us on:</label><br>
                            ...
                            <div class="border-block black full_width text-center">
                                ...
                                <a href="mailto:{{ config('bueno.site.catering_email') }}">{{ config('bueno.site.sales_email') }}</a>
                            </div> <!-- border-block ends -->
