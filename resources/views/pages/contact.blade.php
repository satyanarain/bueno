            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="well padding-md">
                        <h3 class="normal_header">Contact & Feedback</h3>
                    </div> <!-- well ends -->
                    ...
                    <div class="static_content col-xs-12">
                        <div class="main col-xs-12 col-sm-6 col-md-5">
                            ...
                            <h3 class="marginbottom-md paddingleft-sm"><em>Drop us a message!</em></h3>
                            <form action="{{ route('pages.contact.post') }}" class="bueno_form" method="POST">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group bueno_form_group @if($errors->has('subject')){{ 'has-error' }}@endif">
                                    ...
                                    <input type="text" name="subject" required class="bueno_inputtext black full_width" id="subject" placeholder="Subject" value="{{ old('subject') }}">
                                </div> <!-- bueno_form_group ends -->
                                <div class="form-group bueno_form_group @if($errors->has('query')){{ 'has-error' }}@endif">
                                    ...
                                    <textarea class="bueno_inputtext black full_width" required name="query" id="message" rows="6">{{ old('query') }}</textarea>
                                </div> <!-- bueno_form_group ends -->
