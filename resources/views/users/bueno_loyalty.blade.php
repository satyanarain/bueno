                    ...
                    <div class="col-xs-12 account_sec my_account_sec loyalty_sec">
                        ...
                        <section class="title_sec white-bg dashed_border col-xs-12 no-padding">
                            <div class="main-sec col-xs-12">
                                <div class="col-sm-12 col-md-8 left-sec">
                                    <h2 class="style_header_loud">Bueno Rewards</h2>
                                </div> <!-- left-sec ends -->
						...
						<div class="static_content col-xs-12">
							<div class="main col-xs-12 col-md-9">
								...
								<p><b>We have temporarily stopped redemption of your rewards / points but are coming back with a blockbuster redemption program.</b></p>
								<p><b>In the meanwhile, basis your membership tier (Gold / Diamond / Platinum), you will still accrue cashbacks in each order basis our 'Order & Earn' program. Inconvenience is deeply regretted. Please stay with us and keep ordering / referring for greater benefits in the near future!</b></p>
							</div> <!-- main ends -->
