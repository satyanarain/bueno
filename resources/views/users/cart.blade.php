            ...
            <form action="{{ route('checkout.post') }}" method="POST" class="cart_page_form">
                ...
                @if(auth()->user()->cartItems->count())
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="select_address col-xs-12 no-padding">
                            ...
                            <div class="bueno_form select_address_form">
                                ...
                                <div class="col-xs-12 delivery_addresses">
                                    <div class="radio col-xs-12 col-md-4 user_order_delivery_type_row">
                                        <label class="left full_width">
                                             <span class="txt"><strong class="text-uppercase">Delivery</strong>
                                                 <p class="normal_para">&nbsp;</p></span>
                                                 <p class="normal_para">&nbsp;</p></span>
                                            <input type="radio" name="is_pickup" value="0" checked="checked" class="inputradio" id="radio1">
                                            <span class="check_style left"></span>
                                        </label>
                                    </div> <!-- radio ends -->
                                    <div class="radio col-xs-12 col-md-8 user_order_delivery_type_row">
                                        <label class="left full_width">
                                             <span class="txt"><strong class="text-uppercase">Pickup</strong>
                                                 <p class="normal_para"><i>Pickup Time: {{$kitchen->pickup_time}} Minutes</i></p></span>
                                                 <p class="normal_para"><i>Pickup Address: {{$kitchen->unit_number.' '.$kitchen->address_line1.' '.$kitchen->address_line2.' '.$kitchen->sub_area}}</i></p></span>
                                            <input type="radio" name="is_pickup" value="1" class="inputradio" id="radio1">
                                            <span class="check_style left"></span>
                                        </label>
                                    </div> <!-- radio ends -->
                        ...
                        @endif
                        <div class="select_address select_address_area col-xs-12 no-padding">
                                    ...
                                    <td class="product_delivery">
                                       ...
                                       <div class="check_options">
                                        ...
                                        <div class="apply_coupon col-xs-12">
											...
											<br><a href="{{ route('pages.offers.get') }}" target="_blank">check offers section for latest offers</a>
                                        ...
                                        <div class="credits col-xs-12">
                                            <div class="checkbox">
                                                <label class="left large">
                                                    <span class="txt text-uppercase">Use bueno rewards <span class="sub text-capitalize">(Available: {{auth()->user()->points}}, maximum usable on this order: <span class="bueno_usable_points_view"></span>)</span></span>
                                                    <input type="checkbox" name="redeem_points" class="inputcheckbox bueno_points_checkbox" data-maxcreditusageercent="{{ config('bueno.site.max_credit_usage_percent') }}" data-points="{{auth()->user()->points}}" value="1">
                                                    <span class="check_style left"></span>
                                                </label>
                                            </div> <!-- checkbox ends -->
											<h4>KIND ATTENTION:</h4>
											<p>We have temporarily stopped redemption of your rewards / points but are coming back with a blockbuster redemption program.
In the meanwhile, basis your membership tier (Gold / Diamond / Platinum), you will still accrue cashbacks in each order basis our 'Order & Earn' program. Inconvenience is deeply regretted. Please stay with us and keep ordering / referring for greater benefits in the near future!</p>
                                        </div> <!-- credits ends -->
                                        @endif
                                                ...
                                                <div class="col-xs-12 margintop-sm">
                                                    <div class="checkbox">
                                                        <label class="left">
															...
															<span class="txt">{{ $ngo->description }} with ₹ {{ $ngo->default_donation_amount }}</span>
                                    ...
                                    <td class="product_extras">
                                        <div class="payment_method col-xs-12">
                                            <h4 class="heading marginbottom-md">Payment</h4>
                                                        ...
                                                        <div class="panel-heading" role="tab" id="titlePayViaCard">
                                                            <h4 class="panel-title">
                                                                <a role="button" class="arrow_down full_width" data-toggle="collapse" data-parent="#payment_method_accordion" href="#collapsePayViaCard" aria-expanded="true" aria-controls="collapsePayViaCard">
                                                                    Pay via Debit/Credit Card, Net Banking
                                                                </a>
                                                            </h4>
                                                        ...
                                                        <div id="collapsePayViaCard" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="titlePayViaCard">
                                                            <div class="panel-body">
                                                                <div class="radio_options">
                                                                    ...
                                                                    <div class="radio">
                                                                        <label class="left">
                                                                            <span class="txt">Debit/Credit Card, Net Banking</span>
                                                                ...
                                                                <div id="collapsePayViaWallet" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="titlePayViaWallet">
                                                                    <div class="panel-body">
                                                                        <div class="radio_options">
																			...
																			@endif
																			@if($payment_modes->where('id', 9)->where('status',1)->first())
																			<div class="radio">
																				<label class="left">
																					<span class="txt">{{ $payment_modes->where('id', 9)->where('status',1)->first()->name }}</span>
																					<input type="radio" name="payment_mode_id" value="9" class="inputradio cod_payment" id="radio1">
																					<span class="check_style left"></span>
																				</label>
																			</div> <!-- radio ends -->
																			@endif
                                    ...
                                    <td class="product_total">
                                        ...
                                        @elseif($area->delivery_charge)
                                        <div class="full_width delivery_charge_amount">
                                            <p class="total_heading">Delivery Charge</p>
                                            <input type="hidden" name="delivery_charge" class="delivery_charge_input" value="{{ $area->delivery_charge }}"/>
                                            <p class="total_content delivery_charge_text">₹ <span>{{  $area->delivery_charge }}</span></p>
                                        </div>
                                        @endif
                                        ...
                                        <div class="full_width service_charge_amount">
                                            ...
                                            <p class="total_content service_charge_text">₹ <span>{{ applyTax(total_cart_amount(auth()->user()->cartItems), $kitchen->service_charge) }}</span></p>
                                        </div>
                                        @endif

                                        @if($kitchen->value_added_tax)
                                        <div class="full_width value_added_tax_amount">
                                            <p class="total_heading">Value Added Tax</p>
                                            <input type="hidden" name="value_added_tax" class="value_added_tax_input" value="{{ $kitchen->value_added_tax }}"/>
                                            <p class="total_content value_added_tax_text">₹ <span>{{ applyTax(total_cart_amount(auth()->user()->cartItems), $kitchen->value_added_tax) }}</span></p>
                                        </div>
                                        @endif
                                        <div class="full_width total_amount">
                                            ...
                                            <p class="total_content">₹ <span class="checkout-total-amount">{{ applyTax(total_cart_amount(auth()->user()->cartItems), $kitchen->vat) + applyTax(total_cart_amount(auth()->user()->cartItems), $kitchen->service_tax) + total_cart_amount(auth()->user()->cartItems) + $kitchen->service_charge  + $kitchen->area + $kitchen->packaging_charge }}</span></p>
                                        </div>
