...
class Kitchen extends Model{
  ...
  'packaging_charge','delivery_charge','vat','service_tax',
  'service_charge','jooleh_username','jooleh_token',
  'pickup_time','unit_number','address_line1','address_line2',
  'sub_area','longitude','latitude','kitchen_id'];
