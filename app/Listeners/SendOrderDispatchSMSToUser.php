...
class SendOrderDispatchSMSToUser
{
    ...
    public function handle(OrderWasDispatched $event)
    {
        ...
        $this->sms->send($event->order->user->phone, "Hi " . $event->order->user->full_name . ", Your Bueno order No: ". $event->order->order_no." is dispatched and arriving soon with your 'Bueno' meal. Call: ".config('bueno.site.phone'));
    }
}
