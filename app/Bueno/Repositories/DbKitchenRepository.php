...
class DbKitchenRepository  {
  ...
  { 
    ...
    $kitchen->kitchen_id = 'bueno-kitchen-'.$kitchen->id;
  ...
  public function getOutOfStockItems($cart_items, $area_id)
  {
    $outOfStockItems = [];
    foreach($cart_items as $cart_item)
    {
      ...
      if(!$in_stock) array_push($outOfStockItems,$cart_item->item_id);
    }
