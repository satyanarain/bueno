  ...
  public function updateCoupon($id,$inputs)
  {
    ...
    if($inputs['give_meals'])
    {
      foreach ($inputs['give_meals'] as $item) {
        ...
        $this->checkCouponItem($coupon->id,$item['id'],$item['quantity'],'free_item');
      }
    }
  ...
  public function newCoupon($inputs)
  {
    ...
    if($meals!=null)
    {
      foreach ($meals as $meal) {
        ...
        $this->checkCouponItem($coupon->id,$item->id,$meal['quantity'],'free_item');
      }
    }
    ...
    if($combos!=null)
    {
      foreach ($combos as $combo) {
        ...
        $this->checkCouponItem($coupon->id,$item->id,$combo['quantity'],'free_item');
      }
    }
  }
