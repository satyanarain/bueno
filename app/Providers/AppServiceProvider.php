    ...
    public function boot()
    {
      ...
      if($isOpen)
      {
        ...
        foreach ($timings as $timing)
        {
          ...
          $timing_from_display = Carbon::createFromFormat('H:i',$timing->from)->format('g:i A');

          $timing_to_display = Carbon::createFromFormat('H:i',$timing->to)->format('g:i A');
        ...
        View::share('timing_from_display', $timing_from_display);
        View::share('timing_to_display', $timing_to_display);
