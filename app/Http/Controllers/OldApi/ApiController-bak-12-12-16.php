...
class ApiController extends Controller
{
  ...
  public function getAreaKitchen($inputs)
  {
    ...
    if(empty($kitchen['deleviry_charge'])){
      $kitchen['deleviry_charge'] = $area->delivery_charge;
    }

    $kitchen['deleviry_charge'] = empty($kitchen['deleviry_charge']) ? $area->delivery_charge : '';
  ...
  private function transformNgos($ngos)
  {
    ...
    foreach($ngos as $ngo)
    {
      $data[] = [
        ...
        'display_image_url' => $ngo->display_image_url,
      ];
    }
