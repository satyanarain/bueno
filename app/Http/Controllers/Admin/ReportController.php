...
class ReportController extends Controller
{
  ...
  public function displayReport()
  {
    ...
    if(date_diff($start,$end)->days>31)
    {
      Flash::danger('Maximum Range that can be selected is 31 Days');
    ...
    foreach ($orders as $order) {
      ...
      foreach ($order->items as $item) {
        ...
        $stats['item'][$item->id]['total_cost']+=($item->total_cost * $item->pivot->quantity);
		  ...
		  $stats['total_food_cost']='N/A';
		  $stats['total_food_and_packaging_cost']='N/A';
      }
