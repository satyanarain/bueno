...
*/
 ...
 Route::get('trigger-email-welcome/{email}','AuthController@emailTestWelcome');
...
//Groups
    ...
    */
    ...
    Route::get('order/{id}/email-invoice', ['as' => 'admin.orders.email_invoice.get', 'uses' => 'OrderController@emailOrderInvoice']);
    ...
    Route::get('rista-test/{id}', ['as' => 'admin.orders.ristatest', 'uses' => 'OrderController@ristaTest']);
    ...
    */
    ...
    /*
    |---------------------------------------------------------------------------
    | Marketing SMS (SMS Gupshup)
    |---------------------------------------------------------------------------
    */
    Route::get('marketing-sms-template', ['as' => 'admin.marketing_sms_template', 'uses' => 'MarketingSMSController@index']);
    Route::get('marketing-sms-template/new', ['as' => 'admin.new_marketing_sms_template', 'uses' => 'MarketingSMSController@create']);
    Route::post('marketing-sms-template/new', ['as' => 'admin.new_marketing_sms_template', 'uses' => 'MarketingSMSController@store']);
    Route::get('marketing-sms-template/{id}/edit', ['as' => 'admin.update_marketing_sms_template', 'uses' => 'MarketingSMSController@edit']);
    Route::post('marketing-sms-template/{id}/edit', ['as' => 'admin.update_marketing_sms_template', 'uses' => 'MarketingSMSController@update']);
    Route::get('marketing-sms-templatey/{id}/delete', ['as' => 'admin.delete_marketing_sms_template', 'uses' => 'MarketingSMSController@destroy']);
    Route::get('marketing-sms-bulk/{id}', ['as' => 'admin.bulk_marketing_sms', 'uses' => 'MarketingSMSController@bulkSms']);
    Route::post('marketing-sms-bulk/{id}', ['as' => 'admin.bulk_marketing_sms', 'uses' => 'MarketingSMSController@bulkSmsSend']);
...
Route::get('/franchise', ['as' => 'pages.franchise.get', 'uses' => 'PagesController@getFranchise']);
Route::post('/franchise', ['as' => 'pages.franchise.post', 'uses' => 'PagesController@postFranchiseQuery']);
Route::get('/diksha', ['as' => 'pages.diksha.get', 'uses' => 'PagesController@getDiksha']);
...
Route::get('/franchise/download', ['as' => 'pages.franchise.download.get', 'uses' => 'PagesController@getFranchiseDownload']);
...
Route::get('/socialregister', ['as' => 'users.socialregister.get', 'uses' => 'AuthController@socialRegister']);
Route::post('/socialregister', ['as' => 'users.socialregister.post', 'uses' => 'AuthController@postSocailRegister']);
...
Route::post('/olamoneynotify/{payment_mode_id}', ['as' => 'olamoneynotify.success.post', 'uses' => 'CheckoutController@olamoneyNotify']);
