...
viewmore_button = $('#listing_xprs_viewmore_button');
...
$(document).on('click', '#listing_xprs_viewmore_button',function(e){
    getXprsScrollItems();
});

/*$(document).scroll(function(event) {console.log(currentPage)
